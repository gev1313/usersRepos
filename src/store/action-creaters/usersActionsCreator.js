...
export function getSinglUsersRequest(login) {
  return {type: USERS_ACTION_TYPES.USERS_GET_SINGLE_REQUEST,payload: { login } };
}
...
export function loadingType() {
  return { type: USERS_ACTION_TYPES.LOADING, payload: {} };
}

export function showError(error) {
  return { type : USERS_ACTION_TYPES.ERROR, payload : {error} }
}